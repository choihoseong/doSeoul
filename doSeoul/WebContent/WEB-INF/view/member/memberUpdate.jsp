			...
			<div class="content">
				<div class="memberNewJoin">
					<div class="memberNewJoin_header">
						<img src="${root }/ui/img/New1.jpg"> <span class="spanTitle">회원정보수정</span>
					</div>
					<div class="memberNewJoin_input">
						<div class="input_div">
							...
							<div class="input_text_two">
								<input type="text" name="user_id" size="30" class="type_bar"
						...
						<div class="input_div">
							...
							<div class="input_text_two">
								<input type="password" name="user_password" size="40"
						...
						<div class="input_div">
							...
							<div class="input_text_two">
								<input type="text" name="user_name" size="40" class="type_bar"
									placeholder="이름" disabled="disabled">
							</div>
						</div>
						<div class="input_div">
							<div class="input_text_one">
							...
							<div class="input_text_two">
								...
								<input type="radio" name="user_gender" value="남성" disabled="disabled"/><label
									style="color: gray;">남성</label> <input type="radio"
									name="user_gender" value="여성" disabled="disabled"/><label style="color: gray;">여성</label>
							</div>
						</div>
						<div class="input_div">
							<div class="input_text_one">
							...
							<div class="input_text_two">
								...
								<select name="year" class="select" disabled="disabled">
									<option>년도선택</option>
								...
								</select><label style="color: gray">&nbsp;년</label> 
								<select name="month" class="select" disabled="disabled">
									<option>월선택</option>
								...
								</select><label style="color: gray">&nbsp;월</label>
								 <select name="day"	class="select" disabled="disabled">
									<option>일선택</option>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
						...
						<div class="input_div">
							...
							<div class="input_text_two">
								<input type="text" name="user_email" size="40" class="type_bar"
									placeholder="이메일">
							</div>
						</div>
						<div class="input_div">
							...
							<div class="input_text_two">
								<input type="text" name="user_phone_number" size="40"
									class="type_bar" placeholder="'-' 를 제외하고 입력해주세요">
							</div>
						</div>
						<div class="memberNewJoin_foot">
							<button class="memberNewJoin_foot_input" onclick="">수정완료</button>
